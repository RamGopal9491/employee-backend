...
public interface UserRepository extends JpaRepository<Users, Long >
{
	...
	@Query("select count(U) from Users U where U.email=:username and U.password=:password and U.role=:role")
	public int validateCredentials(@Param("username") String username, @Param("password") String password,@Param("role") String role);
